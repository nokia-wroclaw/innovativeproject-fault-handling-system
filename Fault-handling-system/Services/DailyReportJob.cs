...
namespace Fault_handling_system.Services
{
    ...
    {
        /// <summary>
        /// Method responsible for execution of the job functionality.
        /// Filters all users with admin role, and sends them email 
        /// with the list of all reports from the day before.
        /// </summary>
