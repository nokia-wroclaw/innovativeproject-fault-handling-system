        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MailingList = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleFilter", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduleFilter_ReportFilter_FilterId",
                        column: x => x.FilterId,
                        principalTable: "ReportFilter",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleFilter_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleFilter_FilterId",
                table: "ScheduleFilter",
                column: "FilterId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleFilter_UserId",
                table: "ScheduleFilter",
                column: "UserId");
        }
